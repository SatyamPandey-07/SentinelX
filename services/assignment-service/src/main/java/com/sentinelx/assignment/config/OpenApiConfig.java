package com.sentinelx.assignment.config;
...
public class OpenApiConfig {
    ...
    public OpenAPI openAPI() {
        ...
        return new OpenAPI()
                .info(new Info()
                        .title("SentinelX -- assignment-service")
                        .description("Multi-factor responder scoring with Redis-locked atomic assignment")
                        .version("v1"))

package com.sentinelx.incident.config;
...
public class OpenApiConfig {
    ...
    public OpenAPI openAPI() {
        ...
        return new OpenAPI()
                .info(new Info()
                        .title("SentinelX -- incident-service")
                        .description("Incident lifecycle management with transactional outbox and idempotent creation")
                        .version("v1"))

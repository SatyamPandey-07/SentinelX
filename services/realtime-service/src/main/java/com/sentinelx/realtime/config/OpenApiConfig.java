package com.sentinelx.realtime.config;
...
public class OpenApiConfig {
    ...
    public OpenAPI openAPI() {
        ...
        return new OpenAPI()
                .info(new Info()
                        .title("SentinelX -- realtime-service")
                        .description("WebSocket/STOMP broadcast of live incident events to dispatcher dashboards")
                        .version("v1"))
